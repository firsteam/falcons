...
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/general_express.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 插件的作者 */
    $modules[$i]['author']  = 'wangyabener';

    /* 插件作者的官方网站 */
    $modules[$i]['website'] = 'wangyabener@qq.com';
    ...
    /* 打印单背景 */
    $modules[$i]['print_bg'] = '/images/receipt/dly_general_express.jpg';
...
class general_express
{
     ...
     * @return null
     */
    function general_express($cfg = array())
    {
    ...
    function query($invoice_sn)
    {
        ...
        $str = '<form style="margin:0px" methods="post" '.
            'action="http://www.general_express.net.cn/service/sql.aspx" name="queryForm_' .$invoice_sn. '" target="_blank">'.
