...
if ($_REQUEST['act'] == 'edit')
{
    ...
    $smarty->assign('action_link', array('text' => $_LANG['04_category_list'], 'href' => $cat_info['is_virtual']?'category.php?act=virytual_list':'category.php?act=list'));
    ...
    $smarty->assign('cat_select',  $cat_info['is_virtual']?cat_list1(0, $cat_info['parent_id'], true):cat_list(0, $cat_info['parent_id'], true));
    $smarty->assign('goods_type_list',  goods_type_list(0)); // 取得商品类型
