...
//$modules['02_cat_and_goods']['14_goods_export']     = 'goods_export.php?act=goods_export'; //disable-by-cy
//$modules['02_cat_and_goods']['15_batch_edit']       = 'goods_batch.php?act=select'; // 商品批量修改 disable-by-cy
//$modules['02_cat_and_goods']['16_goods_script']     = 'gen_goods_script.php?act=setup'; //disable-by-cy
...
//$modules['02_cat_and_goods']['goods_auto']             = 'goods_auto.php?act=list'; //disable-by-cy
