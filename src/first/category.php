...
else
{
	...
	$sort = (isset($_REQUEST['sort']) && in_array(trim(strtolower($_REQUEST['sort'])), array('goods_id', 'shop_price', 'last_update','click_count','goods_number', 'salenum','(sort_order-is_best*100)'))) ? trim($_REQUEST['sort'])  : $default_sort_order_type;  
