...
define('APP_ROOT_PATH', str_replace('includes/init.php', '', str_replace('\\', '/', __FILE__)));
define('ROOT_PATH',str_replace('app/', '', APP_ROOT_PATH));
...
require(APP_ROOT_PATH . 'includes/app_constant.php');
/* 对用户传入的变量进行转义操作。*/
...
if ($_CFG['shop_closed'] == 1)
{
    ...
    die(json_encode(array('error'=>'100','message'=>$_LANG['shop_closed'] .'，'. $_CFG['close_comment'] )));
}
...
if(!defined('INIT_NO_SMARTY') && !defined('INIT_NO_USERS'))
/* 判断是否登录 */
