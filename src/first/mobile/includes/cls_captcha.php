 ...
 * ============================================================================
 * $Author: derek $
 * $Id: cls_captcha.php 17217 2011-01-19 06:29:08Z derek $
*/
...
//         5 => array('captcha_bg5.gif', 255, 255, 255),
    ...
    function generate_image($word = false)
    {
        ...
        else
        {
            ...
            if(rand(0, 1) == 0)
            {
            	$position = array('-'.rand(0, 10), 30, 15);
            }
            else 
            {
            	$position = array(rand(0, 10), 30, 18);
            }
            //字体
            $ttf_font = $this->folder.'/arial.ttf';
            
            ImageTTFText($img_org, 12, $position[0], $position[1], $position[2], $clr, $ttf_font, $word);
