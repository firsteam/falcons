...
function order_goods($order_id)
{
    $sql = "SELECT og.rec_id, og.goods_id, og.goods_name, og.goods_sn, og.market_price, og.goods_number, " .
            ...
            " WHERE order_id = '$order_id' and og.goods_id = g.goods_id";
...
function cart_goods($type = CART_GENERAL_GOODS)
{
    ...
    $sql = "SELECT rec_id, user_id, goods_id, goods_name, goods_sn, goods_number, " .
            ...
            "AND rec_type = '$type' $id_ext ";  //代码修改 By  www.68ecshop.com  增加一个 $id_ext
 ...
 * @return  array
 */
function get_cart_goods($id_ext='')    //代码修改  By  www.68ecshop.com   增加一个参数 $id_ext
{
    /* 初始化 */
    $goods_list = array();
    $total = array(
    ...
    $sql = "SELECT *, IF(parent_id, parent_id, goods_id) AS pid " .
            " FROM " . $GLOBALS['ecs']->table('cart') . " " .
            " WHERE session_id = '" . SESS_ID . "' AND rec_type = '" . CART_GENERAL_GOODS . "' $id_ext " .  //代码修改   By   www.68ecshop.com，  增加 $id_ext
