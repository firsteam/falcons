...
{
obj = document.getElementById('shipping_'+obj);
obj.checked=true;
...
{
obj = document.getElementById('payment_'+obj);
obj.checked=true;
...
{
obj = document.getElementById('pack_'+obj);
obj.checked=true;
...
{
obj = document.getElementById('card_'+obj);
obj.checked=true;
...

{
...

  {
    ...
    var layer_t = document.getElementById("ECS_ORDERTOTAL_T");

    layer.innerHTML=(typeof result == "object") ? result.content : result;
	/*yyy新增*/
	layer_t.innerHTML=result.total_price;
