 ...
 <form method="post" action="user.php" id="edit_profile">
 			  <div class="name"><span>用户名</span><input type="text" name="user_name" value="<?php echo $this->_var['profile']['user_name']; ?>" placeholder="*用户名" class="c-f-text"></div>
		      <div class="name">
     <span><?php echo $this->_var['lang']['birthday']; ?></span>                  
                       <?php echo $this->html_select_date(array('field_order'=>'YMD','prefix'=>'birthday','start_year'=>'-60','end_year'=>'+1','display_days'=>'true','month_format'=>'%m','day_value_format'=>'%02d','time'=>$this->_var['profile']['birthday'])); ?></div>
		      <div class="name1"><span><?php echo $this->_var['lang']['sex']; ?></span>
                    
                      <label for="sex0"><input type="radio" name="sex" value="0"<?php if ($this->_var['profile']['sex'] == 0): ?> checked="checked"<?php endif; ?> tabindex="2" class="radio" id="sex0"/><?php echo $this->_var['lang']['secrecy']; ?></label>
					<label for="sex1"><input type="radio" name="sex" value="1"<?php if ($this->_var['profile']['sex'] == 1): ?> checked="checked"<?php endif; ?> tabindex="3" class="radio" id="sex1"/><?php echo $this->_var['lang']['male']; ?></label>
					<label for="sex2"><input type="radio" name="sex" value="2"<?php if ($this->_var['profile']['sex'] == 2): ?> checked="checked"<?php endif; ?> tabindex="4" class="radio" id="sex2"/><?php echo $this->_var['lang']['female']; ?></label>
                    </div>
                 <div class="name">
                   <label for="email_ep"> 
                   <span>邮箱</span>
...
?>
            ...
            <div class="field_pwd">
				...
				<label for="extend_field_<?php echo $this->_var['field']['id']; ?>">
