...
?>
<a target="_blank" title="" href="<?php echo $this->_var['ad']['url']; ?>"><img  src="<?php echo $this->_var['ad']['image']; ?>" width="209" height="155" alt=""></a>
		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		</span>
		<?php endif; ?>	  
...
?> 
        ...
        <div class="fen_img">     
        <a href="<?php echo $this->_var['childer']['url']; ?>"><img alt="" src="data/catthumb/<?php echo $this->_var['childer']['img']; ?>"><em><?php echo $this->_var['childer']['name']; ?></em></a> 
        </div> 
        <?php else: ?> 
        <div class="fen">
