    ...
    <?php endif; ?>
      ...
      <div class="tab_nav">
        <div class="header">
          ...
          <div class="h-mid"><?php if ($this->_var['action'] == 'default'): ?>我的账户 <?php elseif ($this->_var['action'] == 'affiliate'): ?>我的推荐<?php elseif ($this->_var['action'] == 'booking_list'): ?>缺货登记<?php elseif ($this->_var['action'] == 'collection_list'): ?>我的收藏<?php elseif ($this->_var['action'] == 'message_list'): ?>我的留言<?php elseif ($this->_var['action'] == 'comment_list'): ?>我的评价<?php endif; ?></div>
          <div class="h-right">
            <aside class="top_bar">
