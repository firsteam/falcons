...
<ul id="menu-ul">
 ...
 <li class="button" key="12_favourable" name="menu">

  <a href="javascript:void(0);"><em id="h1_12_favourable"></em>促销管理<span id="fa_12_favourable"></span></a></li>

  <li class="dropdown" id="12_favourable">
    <ul>
        <li class="dropdown"><a href="favourable.php?act=list" target="main_frame">优惠活动</a></li>
    </ul>
