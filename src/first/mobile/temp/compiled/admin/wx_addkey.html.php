...
<form name="theForm" method="post" action="weixin.php?act=addkey&id=<?php echo $this->_var['keywords']['id']; ?>" enctype="multipart/form-data">
  ...
  <tr id="menuvalue" <?php if ($this->_var['keywords'] [ 'diy_type' ] == 2): ?>style="display:none"<?php endif; ?>>
	...
	<td><textarea name="description1" cols="40" rows="5"><?php echo htmlspecialchars($this->_var['article']['description']); ?></textarea></td>
