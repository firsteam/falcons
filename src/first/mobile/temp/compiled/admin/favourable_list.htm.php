<!-- $Id: favourable_list.htm 14216 2015-02-10 02:27:21Z derek $ -->
...
?>
    <tr>
      <td align="center"><input value="<?php echo $this->_var['favourable']['act_id']; ?>" name="checkboxes[]" type="checkbox"><?php echo $this->_var['favourable']['act_id']; ?></td>
      <td>
      <?php if ($this->_var['favourable']['act_img'] == 1): ?><a href = "../data/actimg/<?php echo $this->_var['favourable']['act_imgfile']; ?>" target="_brank"><img src="images/picflag.gif" width="16" height="16" border="0" alt="" /></a><?php else: ?><img src="images/picnoflag.gif" width="16" height="16" border="0" alt="" /><?php endif; ?>
      <?php echo htmlspecialchars($this->_var['favourable']['act_name']); ?></td>
      <td align="center"><?php echo $this->_var['favourable']['start_time']; ?></td>
      <td align="center"><?php echo $this->_var['favourable']['end_time']; ?></td>
      <td align="center"><?php echo $this->_var['favourable']['min_amount']; ?></td>
      <td align="center"><?php echo $this->_var['favourable']['max_amount']; ?></td>
