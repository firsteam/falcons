...
<body style="background: rgb(235, 236, 237);">
      ...
      <div class="tab_nav">
        <div class="header">
          ...
          <div class="h-mid"><?php if ($this->_var['action'] == 'profile'): ?>个人设置<?php elseif ($this->_var['action'] == 'bonus'): ?>我的红包<?php elseif ($this->_var['action'] == 'order_list'): ?>我的订单<?php elseif ($this->_var['action'] == 'order_detail'): ?>订单详情<?php elseif ($this->_var['action'] == 'account_log' || $this->_var['action'] == 'account_deposit' || $this->_var['action'] == 'account_raply' || $this->_var['action'] == 'account_detail' || $this->_var['action'] == 'act_account' || $this->_var['action'] == 'pay'): ?>资金管理<?php elseif ($this->_var['action'] == 'address_list'): ?>地址管理<?php elseif ($this->_var['action'] == 'address'): ?>地址管理<?php endif; ?></div>
          <div class="h-right">
            <aside class="top_bar">
...
<?php if ($this->_var['action'] != 'order_detail'): ?><?php if ($this->_var['action'] != 'address_list'): ?><?php if ($this->_var['action'] != 'address'): ?>
