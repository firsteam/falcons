      ...
      <div class="main" id="user_goods_ka_1" style="display:block;">
          ...
          <form action="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" method="post" id="purchase_form" name="ECS_FORMBUY" >
            <div class="product_info">
              ...
              <dt><?php if ($this->_var['goods']['is_promote'] && $this->_var['goods']['gmt_end_time']): ?> 
              <span id="ECS_GOODS_AMOUNT" style=" margin-left:10px;"><?php echo $this->_var['goods']['promote_price']; ?></span><strong ><?php echo $this->_var['goods']['shop_price_formated']; ?> </strong> 
              <?php else: ?> 
              <span id="ECS_GOODS_AMOUNT" style="  margin-left:10px;"><?php echo $this->_var['goods']['shop_price_formated']; ?></span><strong><?php echo $this->_var['goods']['market_price']; ?></strong>
              <?php endif; ?></dt>
...
?>
          ...
          <li><img src="themesmobile/68ecshopcom_mobile/images/hui.png">购买<?php echo $this->_var['price_list']['number']; ?>件&nbsp;优惠价：<strong><?php echo $this->_var['price_list']['format_price']; ?></strong></li> 
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          </ul>
          <?php endif; ?>
...
<div class="subNavBox"> 
	...
	<li style=" border-bottom:1px solid #eeeeee">
        ...
        <div class="item1">
         ...
         <span class="ui-number">
          <button type="button" class="decrease" onclick="goods_cut();changePrice();">-</button>
          <input type="number" class="num" id="number" onblur="changePrice();" name="number" value="1" min="1" max="<?php echo $this->_var['goods']['goods_number']; ?>"/>
          <button type="button" class="increase" onclick="goods_add();changePrice();">+</button>
          </span>
      </div>
...
<section class="index_floor is_scroll" style="border-top:1px solid #ddd ">
    <h2>
      ...
      <div class="bd">
        <ul>
           <?php $_from = $this->_var['fittings']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_22127500_1443055447');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_22127500_1443055447']):
?>
          <li>
            <a href="<?php echo $this->_var['goods_0_22127500_1443055447']['url']; ?>">
              <div class="products_kuang">
                <img src="<?php echo $this->_var['goods_0_22127500_1443055447']['goods_thumb']; ?>"></div>
              <div class="goods_name"><?php echo htmlspecialchars($this->_var['goods_0_22127500_1443055447']['short_name']); ?></div>
              <div class="price" >
              <p href="<?php echo $this->_var['goods_0_22127500_1443055447']['url']; ?>"><?php echo $this->_var['goods_0_22127500_1443055447']['fittings_price']; ?> </p>
                 <a href="javascript:addToCart(<?php echo $this->_var['goods_0_22127500_1443055447']['goods_id']; ?>);" class="car">
                    <img src="themesmobile/68ecshopcom_mobile/images/xin/cutp.png">
                </a>
              </div>
            </a>
