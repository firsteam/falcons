      ...
      <div class="pagenav-content">
        <div class="pagenav" id="J_PageNav">
          ...
          <div class="pagenav-cur" style="vertical-align:bottom">
            <div class="pagenav-text" > <span><?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_40046500_1443005279');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_40046500_1443005279']):
?>
...
<?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_40098800_1443005279');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_40098800_1443005279']):
?>
  <option <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?>selected="selected"<?php endif; ?> value="<?php echo $this->_var['item_0_40098800_1443005279']; ?>">第<?php echo $this->_var['key']; ?>页</option>
