<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:74:"D:/wwwroot/xjdxin/wwwroot/mobile/themesmobile/68ecshopcom_mobile/goods.dwt";i:1;s:84:"D:/wwwroot/xjdxin/wwwroot/mobile/themesmobile/68ecshopcom_mobile/library/up_menu.lbi";i:2;s:90:"D:/wwwroot/xjdxin/wwwroot/mobile/themesmobile/68ecshopcom_mobile/library/goods_gallery.lbi";i:3;s:85:"D:/wwwroot/xjdxin/wwwroot/mobile/themesmobile/68ecshopcom_mobile/library/comments.lbi";}s:7:"expires";i:1444048788;s:8:"maketime";i:1444045188;}<!DOCTYPE html >
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width">
<title>雀巢(Nestle)超级能恩幼儿配方奶粉 3段 800克_孕婴奶粉_母婴用品_ecshop开发中心  </title>
<meta name="Keywords" content="雀巢" />
<meta name="Description" content="德国原装进口、适度水解配方、全面营养 )" />
...
location.href='share_goods.php?content=雀巢(Nestle)超级能恩幼儿配方奶粉 3段 800克&pics=../images/201507/goods_img/209_G_1437583601250.jpg&gid=209&url='+thisurl;
}
</script>
...
<div class="goods_nav hid" id="menu">
  ...
  <div id="slider" class="slider">
    <ul id="sliderlist" class="sliderlist">
             <li style="float: left; display: block; width:100%;"><span><a  href="javacript:void(0)"><img title="" width="100%" src="../images/201507/goods_img/209_P_1437583601805.jpg"></a></span></li>
           </ul>
...
var t2=new TouchSlider({id:'sliderlist', speed:600, timeout:6000, before:function(index){
		...
		as[active].className='active';
          ...
          <form action="javascript:addToCart(209)" method="post" id="purchase_form" name="ECS_FORMBUY" >
            <div class="product_info">
              <div class="info_dottm">
                <h3 class="name">雀巢(Nestle)超级能恩幼儿配方奶粉 3段 800克</h3>
                <div class="right"><a onClick="tiaozhuan()"><div id="pro_share" class="share"></div></a></div>
              </div>
              
              <dl class="goods_price">
              <dt> 
              <span id="ECS_GOODS_AMOUNT" style="  margin-left:10px;">￥278元</span><strong>￥334元</strong>
              </dt>
	...
	<li style=" border-bottom:1px solid #eeeeee">
        ...
        <div class="item1">
         ...
         <span class="ui-number">
          ...
          <input type="number" class="num" id="number" onblur="changePrice();" name="number" value="1" min="1" max="15656"/>
...
<div class="subNavBox" > 
    ...
    <li>			
         ...
         <b class="p-price-v">￥264元</b>
         </p>
             <p>
         <span class="key">金牌会员：</span>
         <b class="p-price-v">￥250元</b>
         </p>
             <p>
         <span class="key">钻石会员：</span>
         <b class="p-price-v">￥236元</b>
         </p>
...
changePrice();
      ...
      <div class="product_main" style=" margin-top:40px;"> 
          <div class="product_images product_desc" id="product_desc"> <p style="text-align: center;"><img class="" src="http://www.xjd.test/includes/ueditor/php/../../../images/image/94661437612328.jpg" style="" data-lazyload="done"/></p><p style="text-align: center;"><img class="" src="http://www.xjd.test/includes/ueditor/php/../../../images/image/14931437612329.jpg" style="" data-lazyload="done"/></p> </div>
        </div>
              </div> 
      
      <div class="tab_attrs tab_item hide" id="user_goods_ka_3" style="display:none;">
        <script type="text/javascript" src="js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:209;}554fcae493e564ee0dc75bdf2ebf94ca</div>
...
<div class="footer_nav">
 ...
 <li><a href="javascript:collect(209)" id="favorite_add"><em class="goods_nav3"></em><span>收藏</span></a></li>
 </ul>
 <dl>
 <dd class="flow"><a class="button active_button" href="javascript:addToCart(209);">加入购物车</a> </dd>
 <dd class="goumai"><a style="display:block;" href="javascript:addToCart1(209)">立即购买</a> </dd>
 </dl>                
</div>                  
<script type="text/javascript">
var goods_id = 209;
